            ...
            <div className="relative">
                ...
                src="https://plus.unsplash.com/premium_photo-1681140560806-928e8b9a9a20?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                 ...
                 <div className="h-full w-3/4 absolute top-0 bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)100%]">
                    <h1 className="text-4xl md:text-7xl font-bold absolute text-white top-40 left-20">Your <span className="text-green-400">Garden</span>, Our Priority...</h1>
                    <p className="text-4xl w-3/4 absolute mt-10 italic text-white top-56 left-20 drop-shadow-lg font-satisfy">Welcome to a place where your outdoor oasis is our canvas, and every plant is a masterpiece.</p>
                    <div className="flex gap-2 absolute bottom-40 left-20">

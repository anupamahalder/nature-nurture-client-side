                ...
                <div className="absolute flex justify-center items-center top-0 h-full w-full bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)100%]">
                    ...
                    <div className="mt-4 md:mt-10 ml-4 md:ml-16">
                        <Link to='/service'><button
                         className="btn md:text-xl hover:bg-green-300 hover:text-black mr-2">Check Services</button></Link>
                        <Link to='/service'><button className="btn btn-outline hover:bg-white hover:text-black outline-4 md:text-xl text-white">Book Now</button></Link>
                    </div>
                    </div>
                 </div>
            </div>
